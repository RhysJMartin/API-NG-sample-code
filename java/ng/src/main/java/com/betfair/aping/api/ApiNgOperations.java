...
public abstract class ApiNgOperations {
    ...
    //RHMA: New Operation
    public abstract List<CompetitionResult> listCompetitions(MarketFilter myFilter, String appKey, String ssoId) throws APINGException;

    //RHMA: New Operation
    public abstract List<EventResult> listEvents(MarketFilter myFilter, String appKey, String ssoId) throws APINGException;
